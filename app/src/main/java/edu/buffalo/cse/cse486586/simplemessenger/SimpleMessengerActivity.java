...
Log.e(TAG, "myport "+ myPort);
    ...
    class HandleClient extends ServerTask implements Runnable {
        ...
        private Socket soc;
        HandleClient(ServerSocket socS, Socket soc)
        {
            this.soc = soc;
            this.socS =  socS;
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            try {
                while (true) {
                    ...
                    new HandleClient(serverSocket, socket);
...
private class ClientTask extends AsyncTask<String, Void, Void> {
    ...
    protected Void doInBackground(String... msgs) {
        try {
            ...
            Log.d(TAG, "doInBackground: "+  msgs[1]);
            Log.d(TAG, "doInBackground: remote "+ remotePort);
            ...
            if (str != null) {
                ...
                try {
                    ...
                    Log.d(TAG, "doInBackground: sending message " + str);
                    out.println(str);
                } catch (Exception e) {
            ...
            Log.e(TAG, "ClientTask UnknownHostException" + e.getCause());
        } catch (IOException e) {
